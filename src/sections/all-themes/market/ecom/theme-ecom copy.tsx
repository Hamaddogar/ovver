              ...
              <Box sx={{ display: 'flex', gap: '20px', flexDirection: 'column', pt: '20px' }}>
                ...
                >
                  {dataPages.map((page) => (
                    <MenuItem
                      key={page.title}
                      selected={controlls.page === page.title}
                      sx={{ marginBottom: '20px', fontWeight: 600, fontSize: '12px !important' }}
                      onClick={handleCloseDropDown('menu', page.title)}
                    >
                      {page.title}
                    </MenuItem>
                  ))}
            ...
            <Grid container xs={12} sm={5} sx={{ display: controlls.addSection ? 'none' : '' }}>
              <Grid xs={10}>
                ...
                >
                  ...
                  {buttonSection === 'CategoriesLayout' && (
                    <Box>
                      <HeaderSection
                        ...
                        handleThemeConfig={handleThemeConfig}
                      />
                      <LayoutCategoriesDealer
                        handleThemeConfig={handleThemeConfig}
                        themeConfig={themeConfig}
                      />
                    </Box>
                  )}
                  {buttonSection === 'Products' && (
                    <Box>
                      <HeaderSection
                  ...
                  {buttonSection === 'Similar Products' && (
                    <Box>
                      <HeaderSection
                        ...
                        handleThemeConfig={handleThemeConfig}
                      />
                      <SimilarProductsDealer
                        handleThemeConfig={handleThemeConfig}
                        themeConfig={themeConfig}
                      />
                    </Box>
                  )}
                  {buttonSection === 'Wishlist' && (
                    <Box>
                      <HeaderSection
                        name="Wishlist"
                        description=""
                  ...
                  <Scrollbar>
                    ...
                    {activeSection === 'Layout' && (
                      <Box>
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  minWidth: 'auto',
                                  borderRadius: '12px',
                                  background: buttonSection === 'Nav' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background: buttonSection === 'Nav' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  minWidth: 'auto',
                                  borderRadius: '12px',
                                  background: buttonSection === 'Header' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background: buttonSection === 'Header' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  borderRadius: '12px',
                                  background:
                                    buttonSection === 'CategoriesLayout' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background:
                                      buttonSection === 'CategoriesLayout' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  minWidth: 'auto',
                                  borderRadius: '12px',
                                  background: buttonSection === 'Products' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background:
                                      buttonSection === 'Products' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  minWidth: 'auto',
                                  borderRadius: '12px',
                                  background: buttonSection === 'List View' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background:
                                      buttonSection === 'List View' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  borderRadius: '12px',
                                  background:
                                    buttonSection === 'Card Style' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background:
                                      buttonSection === 'Card Style' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  borderRadius: '12px',
                                  background:
                                    buttonSection === 'Card Shape' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background:
                                      buttonSection === 'Card Shape' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  minWidth: 'auto',
                                  borderRadius: '12px',
                                  background: buttonSection === 'Search' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background: buttonSection === 'Search' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  minWidth: 'auto',
                                  borderRadius: '12px',
                                  background: buttonSection === 'Filter' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background: buttonSection === 'Filter' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  borderRadius: '12px',
                                  background:
                                    buttonSection === 'Product Card' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background:
                                      buttonSection === 'Product Card' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                        ...
                        {controlls.page === 'Product Details Page' && (
                          <Stack
                            alignItems="center"
                            sx={{ height: '100%', textAlign: 'center', transition: 'all .5s' }}
                            spacing="20px"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  minWidth: 'auto',
                                  borderRadius: '12px',
                                  background: buttonSection === 'Images' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background: buttonSection === 'Images' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  borderRadius: '12px',
                                  background:
                                    buttonSection === 'Description' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background:
                                      buttonSection === 'Description' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  borderRadius: '12px',
                                  background:
                                    buttonSection === 'Similar Products' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background:
                                      buttonSection === 'Similar Products' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  minWidth: 'auto',
                                  borderRadius: '12px',
                                  background: buttonSection === 'Wishlist' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background:
                                      buttonSection === 'Wishlist' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                            ...
                            <Stack spacing="3px" alignItems="center" justifyContent="center">
                              <Button
                                sx={{
                                  ...
                                  minWidth: 'auto',
                                  borderRadius: '12px',
                                  background: buttonSection === 'User Info' ? '#1BFBB6' : '#F5F5F8',
                                  '&:hover': {
                                    background:
                                      buttonSection === 'User Info' ? '#22C55E' : '#DEE1E6',
                                  },
                                }}
                                variant="contained"
                      ...
                      {activeSection === 'Style' && (
                        ...
                        >
                          <Stack spacing="3px" alignItems="center" justifyContent="center">
                            ...
                            <Typography variant="caption" color="#0F1349" fontWeight={900}>
                              Font
                            </Typography>
                          </Stack>
                              ...
                              <Stack spacing="3px" alignItems="center" justifyContent="center">
                                <Button
                                  sx={{
                                    ...
                                    '&:hover': {
                                      background:
                                        buttonSection === 'Header' ? '#22C55E' : '#DEE1E6',
                                    },
                                  }}
                                  variant="contained"
                                  onClick={handleButton('Header')}
                              ...
                              <Stack spacing="3px" alignItems="center" justifyContent="center">
                                <Button
                                  sx={{
                                    ...
                                    borderRadius: '12px',
                                    background:
                                      buttonSection === 'Products' ? '#1BFBB6' : '#F5F5F8',
                                    '&:hover': {
                                      background:
                                        buttonSection === 'Products' ? '#22C55E' : '#DEE1E6',
                                    },
                              ...
                              <Stack spacing="3px" alignItems="center" justifyContent="center">
                                <Button
                                  sx={{
                                    ...
                                    borderRadius: '12px',
                                    background:
                                      buttonSection === 'List View' ? '#1BFBB6' : '#F5F5F8',
                                    '&:hover': {
                                      background:
                                        buttonSection === 'List View' ? '#22C55E' : '#DEE1E6',
                                    },
                              ...
                              <Stack spacing="3px" alignItems="center" justifyContent="center">
                                <Button
                                  sx={{
                                    ...
                                    '&:hover': {
                                      background:
                                        buttonSection === 'Search' ? '#22C55E' : '#DEE1E6',
                                    },
                                  }}
                                  variant="contained"
                                  onClick={handleButton('Search')}
                              ...
                              <Stack spacing="3px" alignItems="center" justifyContent="center">
                                <Button
                                  sx={{
                                    ...
                                    '&:hover': {
                                      background:
                                        buttonSection === 'Filter' ? '#22C55E' : '#DEE1E6',
                                    },
                                  }}
                                  variant="contained"
                                  onClick={handleButton('Filter')}
                              ...
                              <Stack spacing="3px" alignItems="center" justifyContent="center">
                                <Button
                                  sx={{
                                    ...
                                    '&:hover': {
                                      background:
                                        buttonSection === 'Images' ? '#22C55E' : '#DEE1E6',
                                    },
                                  }}
                                  variant="contained"
                                  onClick={handleButton('Images')}
                              ...
                              <Stack spacing="3px" alignItems="center" justifyContent="center">
                                <Button
                                  sx={{
                                    ...
                                    borderRadius: '12px',
                                    background:
                                      buttonSection === 'Wishlist' ? '#1BFBB6' : '#F5F5F8',
                                    '&:hover': {
                                      background:
                                        buttonSection === 'Wishlist' ? '#22C55E' : '#DEE1E6',
                                    },
                              ...
                              <Stack spacing="3px" alignItems="center" justifyContent="center">
                                <Button
                                  sx={{
                                    ...
                                    borderRadius: '12px',
                                    background:
                                      buttonSection === 'User Info' ? '#1BFBB6' : '#F5F5F8',
                                    '&:hover': {
                                      background:
                                        buttonSection === 'User Info' ? '#22C55E' : '#DEE1E6',
                                    },
                    ...
                    <Stack direction="row" justifyContent="space-between">
                      <Box>
                        ...
                        <Typography variant="caption">
                          Select the view of the categories list
                        </Typography>
                      </Box>
                      <Stack direction="row" spacing="15px">
                        <Iconify
                  ...
                  <Actions condition={buttonSection === 'View'}>
                    <Stack direction="row" justifyContent="space-between">
                      <Box>
                        ...
                        <Typography variant="caption">
                          Select the view of the product list
                        </Typography>
                      </Box>
                      <Stack direction="row" spacing="15px">
                        <Iconify
