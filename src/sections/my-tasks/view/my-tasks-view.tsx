    ...
    <Container maxWidth={false}>
      ...
      >
        ...
        <Grid item xs={12} sm={6} md={4}>
          ...
          >
            <Button
              onClick={handleChangeCategory('tasks')}
              fullWidth
              variant="contained"
              sx={
            ...
            <Button
              onClick={handleChangeCategory('calls')}
              fullWidth
              variant="contained"
              sx={
              ...
              <Box sx={{ maxWidth: { xs: '100%', sm: '160px' } }}>
                <Linker path={paths.dashboard.tasks.book}>
                  <Button
                    ...
                    variant="contained"
                    color="primary"
                    startIcon={<Box component="img" src="/raw/OverZaki.svg" />}
                    sx={{
                ...
                <TabPanel value={value.tasks} sx={{ px: 0, pb: 0 }}>
                  <Grid container spacing={2}>
                    {[
                      ...
                      .filter((item) =>
                        item.status === value.tasks ? true : value.tasks === 'All'
                      )
                      .map((product, indx) => (
                ...
                <TabPanel value={value.calls} sx={{ px: 0, pb: 0 }}>
                  <Grid container spacing={2}>
                    {[
                      ...
                      .filter((item) => item.status === value.calls)
                      .map((product, indx) => {
