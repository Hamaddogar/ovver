                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    >
                      <Chip
                        size="small"
                        label={item.idNo}
                        sx={{ backgroundColor: 'rgb(27, 252, 182,.2)', color: '#0F1349' }}
                      />
                      <Box
                        sx={{
                          width: '60px',
                      ...
                      <Box display="flex" gap="0px" flexDirection="column">
                        <Typography component="span" variant="h6" sx={{ fontSize: '.8rem' }}>
                          {item.name}
                        </Typography>
                        <Typography
                          component="span"
                          variant="subtitle2"
                          sx={{ opacity: 0.8, fontSize: '.8rem' }}
                        >
                          {item.category}
                        </Typography>
                      </Box>
                  ...
                  >
                    <Grid item xs="auto">
                      <Typography
                        component="p"
                        variant="subtitle2"
                        sx={{ opacity: 0.7, fontSize: '.7.5rem' }}
                      >
                        Price
                      </Typography>
                      <Typography component="p" variant="h6" sx={{ fontSize: '.8rem' }}>
                        {item.price} <span style={{ fontSize: '12px' }}>KWD</span>
                      </Typography>
                    </Grid>
                    <Grid item xs="auto">
                      <Typography
                      ...
                      <Typography component="p" variant="h6" sx={{ fontSize: '.8rem' }}>
                        {item.totalSales} <span style={{ fontSize: '12px' }}>sales</span>
                      </Typography>
                    </Grid>
                    <Grid item xs="auto">
                      <Box
                      ...
                      >
                        <Typography
                          ...
                          component="p"
                          variant="subtitle2"
                          sx={{ opacity: 0.8, fontSize: '.8rem', color: '#00DF9A' }}
                        >
                          {item.growth}
                        </Typography>
                        <Box
