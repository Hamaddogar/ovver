      ...
      <Grid container spacing={3} alignItems="center" justifyContent="center">
        ...
        <Grid xs={12}>
          ...
          >
            ...
            <Switch name="time" checked={checked} onChange={() => setchecked((pv) => !pv)} />
            <Typography variant="body2" sx={{ opacity: 0.8 }}>
              {' '}
              Yearly{' '}
            </Typography>
          ...
          >
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb="20px">
              <Box>
                ...
                <Typography variant="subtitle2" sx={{ opacity: 0.8 }} component="del">
                  120 KWD/year
                </Typography>
              </Box>
            ...
            <Box mt="20px">
              {[
                ...
                <Stack key={indx} direction="row" alignItems="center" spacing="14px" mb="16px">
                  <Box
                    component="img"
                    src={item.included ? '/raw/CheckGreen.svg' : '/raw/Missed.svg'}
                  />
                  <Typography variant="subtitle2" sx={{ opacity: item.included ? 0.8 : 0.4 }}>
                    {item.title}{' '}
                  </Typography>
                </Stack>
              ))}
            ...
            <Stack direction="row" alignItems="center" spacing="14px">
              ...
              <Typography variant="subtitle2" sx={{ opacity: 0.9 }} color="default">
                See More
              </Typography>
            </Stack>
          </Paper>
